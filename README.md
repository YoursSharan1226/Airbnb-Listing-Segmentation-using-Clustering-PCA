...
The Folium-based interactive map output is not included in this repository due to file size constraints (approximately 55MB).

The map can be regenerated by running the notebook, or provided upon request.
